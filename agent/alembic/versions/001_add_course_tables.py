...
def upgrade():
    ...
    """)
    op.execute("CREATE INDEX IF NOT EXISTS ix_courses_ecosystem_id ON courses(ecosystem_id)")
    ...
    """)
    op.execute("CREATE INDEX IF NOT EXISTS ix_quizzes_course_id ON quizzes(course_id)")
    ...
    """)
    op.execute("CREATE INDEX IF NOT EXISTS ix_quiz_results_quiz_id ON quiz_results(quiz_id)")
