...
- [ ] **Task 1.2: Draft emergency-criteria-design SKILL.md -- sections A through F**
  ...
  - **B. Domain Scope:** Any governance body that may need to operate under emergency conditions. Criteria are defined per ETHOS or at ecosystem level, never informally.
...
- [ ] **Task 1.3: Draft emergency-criteria-design SKILL.md -- sections G through L**
  ...
  - **L. Cross-Unit Interoperability Impact:** Each ETHOS defines its own emergency criteria. Ecosystem-level criteria are defined through the OSC. An emergency in one ETHOS does not automatically constitute an emergency in another, but ecosystem-level criteria may reference cross-ETHOS cascading effects.
...
- [ ] **Task 1.7: Create pre-authorization-protocol assets**
  ...
  Create `assets/irreducible-constraints.yaml` (the list of actions that no emergency role can ever take, regardless of crisis severity: UAF amendment, ETHOS dissolution, member expulsion, emergency criteria modification, safeguard trigger modification).
