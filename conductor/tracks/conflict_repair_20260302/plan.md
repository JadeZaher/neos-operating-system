...
Note: Layer VI does NOT depend on Layer IV (Economic) or Layer V (Inter-Unit) for its core skills. Layer V's polycentric-conflict-navigation handles structural inter-ETHOS conflicts; Layer VI handles interpersonal and intra-ETHOS conflicts. These are parallel, not sequential.
...
- [ ] **Task 1.3: Draft harm-circle SKILL.md -- sections G through L**
  ...
  - **L. Cross-Unit Interoperability Impact:** When harm crosses ETHOS boundaries (a member of one ETHOS harms a member of another), facilitator selection should be from a third ETHOS if possible. Repair agreements may need consent from both ETHOS if they include structural changes. This is the boundary with Layer V's polycentric-conflict-navigation: if the underlying issue is structural between ETHOS, route to Layer V; if it is interpersonal between individuals who happen to be in different ETHOS, use this skill.
...
- [ ] **Task 1.6: Draft nvc-dialogue SKILL.md -- full skill (sections A-L)**
  ...
  - **B.** Any governance conversation where tension, conflict, or miscommunication is present or anticipated. Applied within harm circles, ACT consent phases (especially when objections are contentious), cross-ETHOS negotiations, coaching conversations, and informal conflict dialogue.
...
- [ ] **Task 2.1: Draft escalation-triage SKILL.md -- sections A through F**
  ...
  - **D. Required Inputs:** Conflict description (from reporter's perspective), parties involved, severity indicators, scope of impact (individual, circle, ETHOS, ecosystem), duration (one-time incident, recurring pattern, systemic issue), urgency level, safety considerations.
  ...
  - Structural dispute between ETHOS: Route to Layer V polycentric-conflict-navigation
...
- [ ] **Task 3.2: Draft repair-agreement SKILL.md -- sections G through L**
  ...
  - **L.** Cross-ETHOS repair agreements (when the conflict crossed ETHOS boundaries) are registered in both ETHOS' agreement registries and follow-up responsibility is assigned to both.
...
- [ ] **Task 3.6: Draft coaching-intervention SKILL.md -- sections G through L**
  ...
  - **L.** Cross-ETHOS coaching (participant in one ETHOS receiving coaching from someone in another ETHOS) is permitted and sometimes preferable (provides outside perspective). The coaching plan is shared with the participant's home ETHOS for transparency but the coaching relationship remains between coach and participant.
...
**Goal:** Build the community-impact-assessment skill -- the broadest-scope skill in Layer VI -- that enables ETHOS-wide processing of community-affecting conflicts and routes systemic findings into governance improvement through ACT.
...
- [ ] **Task 4.2: Draft community-impact-assessment SKILL.md -- sections G through L**
  ...
  - **L.** Cross-ETHOS community impact assessments (when a pattern spans multiple ETHOS) require representatives from all affected ETHOS. Facilitation rotates. Recommendations may include federation agreement amendments (routed through Layer V's federation-agreement skill).
...
- [ ] **Task 5.1: Write Layer VI README.md**
  ...
  - Cross-layer dependencies (Layers I, II, III) and the boundary with Layer V (structural inter-ETHOS conflicts)
...
- [ ] **Task 5.2: Cross-skill review and quality gates**
  ...
  - Verify the boundary between Layer VI (interpersonal/intra-ETHOS) and Layer V (structural inter-ETHOS) is clear in every skill
